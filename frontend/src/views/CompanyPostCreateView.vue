  ...
  <div class="write-container">
      ...
      <div class="write-dashboard">
          ...
          <header class="write-header">
              <h2>{{ companyStore.company?.company_name }} 커뮤니티 글쓰기</h2>
          </header>

          <form @submit.prevent="submitPost" class="write-form">
              <div class="form-group">
                  <label>카테고리</label>
                  <select v-model="postData.category" required>
...
const submitPost = function () {
    ...
    postStore.createPost(postData.value)
}
